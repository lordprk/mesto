...
//Результат
popupOpenButtonAuthor.addEventListener("click",()=>{setAuthorsData(); openPopup(popupAuthorElement)});
popupCloseButtonAuthor.addEventListener("click",()=> closePopup(popupAuthorElement));
